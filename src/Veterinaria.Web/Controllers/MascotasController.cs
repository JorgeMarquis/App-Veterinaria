...
using Veterinaria.Web.ViewModels.Mascotas;
using System;
...
namespace Veterinaria.Web.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public MascotasController(IApplicationDbContext context)
        {
            _context = context;
        }
        ...
        private async Task<IEnumerable<SelectListItem>> GetClientesSelectAsync(int? selectedId = null)
        {
            var clientes = await _context.Clientes
                .Where(c => c.Activo || (selectedId.HasValue && c.IdCliente == selectedId.Value))
            ...
            return clientes.Select(c => new SelectListItem
            {
                ...
                Text = $"{c.NombreCompleto} ({c.NumIdentificacion})" + (!c.Activo ? " - INACTIVO" : ""),
        ...
        {
            var mascotasViewModel = await _context.Mascota
                .Where(m => m.Activo)
                .Select(m => new MascotaViewModel
                {
                    ...
                    ClienteNombre = m.IdClienteNavigation.NombreCompleto,
                    EspecieNombre = m.IdEspecieNavigation.Nombre,
                    RazaNombre = m.IdRazaNavigation != null ? m.IdRazaNavigation.Nombre : "Mestizo/Sin definir"
                })
                .OrderBy(m => m.Nombre)
                .ToListAsync();

            return View(mascotasViewModel);
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            return View("CreateEdit", v_mascotavm);
        }
        ...
        public async Task<IActionResult> Create(MascotaViewModel mascotavm)
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                await LlenarListasViewModel(mascotavm);
                return View("CreateEdit", mascotavm);
            }
        }

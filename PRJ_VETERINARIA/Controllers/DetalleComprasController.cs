...
namespace PRJ_VETERINARIA.Controllers
{
    public class DetalleComprasController : Controller
    {
        ...
        public DetalleComprasController(BDVeterinariaContext context)
        {
            _context = context;
        }
        ...
        {
            var bDVeterinariaContext = _context.DetalleCompras.Include(d => d.IdCompraNavigation).Include(d => d.IdProductoNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdDetalle,IdCompra,IdProducto,Cantidad,PrecioUnitario,Lote,FechaVencimiento,FechaFabricacion,Observaciones,CreatedAt")] DetalleCompra detalleCompra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDetalle,IdCompra,IdProducto,Cantidad,PrecioUnitario,Lote,FechaVencimiento,FechaFabricacion,Observaciones,CreatedAt")] DetalleCompra detalleCompra)
        {
